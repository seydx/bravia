...
const ServiceProtocol = require('./service');
...
class Bravia {
  ...
  async initialize() {
    ...
    for (const protocol of SERVICE_PROTOCOLS) {
      ...
      this.services.set(protocol, new ServiceProtocol(protocol, this.url, this.credentials));
    }
